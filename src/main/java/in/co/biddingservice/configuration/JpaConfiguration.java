package in.co.biddingservice.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "in.co.biddingservice.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "in.co.biddingservice.model" });
